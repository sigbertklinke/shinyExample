curve(from=-4, to=4, dnorm(x, mean=0, sd=1), xaxt="n", yaxt="n",ylab="", xlab="", col="red", ylim=c(0.0,0.45), lty=1, lwd=4, font.lab=2, "xaxs"="i" ,"yaxs"="i", bty="l")
...
text(0, 0.42, expression(paste("Nichtablehnungsbereich ", H[0])))
text(-3, 0.42, expression(paste("Ablehnungsbereich ", H[0])))
