...
par(las=1)
plot(Einkommen2, Nr, pch=16, col="blue", xlab="mittleres Haushaltsnettoeinkommen", "bty"="l", font.lab=2, ylab="Nr. der Stichprobe", xaxt="n", xlim=c(1, 5000), "xaxs"="i", ylim=c(0,26), yaxp=c(0, 26, 13), "yaxs"="i", sub="Abb. 2: Sch\u00E4tzwerte von 25 Zufallsstichproben des Stichprobenumfangs n = 20")
